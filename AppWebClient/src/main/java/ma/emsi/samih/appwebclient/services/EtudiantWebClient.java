package ma.emsi.samih.appwebclient.services;
...
public class EtudiantWebClient {
    ...
    private static final String BASE_URL = "http://localhost:8085/etudiants";
...
// Bloque l’exécution jusqu’à recevoir la réponse (mode synchrone).
    ...
    public Map<String, Object> updateEtudiant(Long id, Map<String, Object> etudiant) {
        try {
            ...
            e.printStackTrace();
            return Map.of("error", "Erreur lors de la mise à jour");
        }
    }

    public Map getEtudiantById(Long id) {
