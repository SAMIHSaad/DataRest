package ma.emsi.samih.appresttemplate.services;
...
public class EtudiantClientService {
    ...
    private final String BASE_URL = "http://localhost:8085/etudiants";
    private static final String BASE_URL2 = "http://localhost:8085/etudiants/search/findEtudiantByNom?n={nom}";
